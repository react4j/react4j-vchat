...
public interface StereoPannerOptions extends AudioNodeOptions {
  ...
  @Nonnull
  @Override
  default StereoPannerOptions channelCountMode(@Nonnull final String channelCountMode) {
  ...
  @Nonnull
  @Override
  default StereoPannerOptions channelInterpretation(@Nonnull final String channelInterpretation) {
